#!/bin/bash
# Run heat influx histogram: (westerly × T>0°C) over peninsula. Use absolute path for Slurm.
set -e
...
export HEAT_DATA_DIR="${PROJECT_ROOT}/dataslices/era5_daily_peninsula"
export FIGS_DIR="${PROJECT_ROOT}/Figs"
python3 "${PROJECT_ROOT}/Python/plot_heat_influx_histogram.py"
